...
import { PREVIEW_CITATION_ROWS, PREVIEW_SOURCE_GROUPS } from "@/lib/preview-data";
    ...
    <Card className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-black">
      ...
      {activeTab === "sources" ? (
        <div className="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800">
          <div className="grid grid-cols-[1.15fr_0.5fr_0.45fr_0.7fr] border-b border-gray-200 bg-gray-50 px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.08em] text-muted-foreground dark:border-gray-800 dark:bg-neutral-950">
            <span>Domain</span>
          ...
          <div>
            {PREVIEW_SOURCE_GROUPS.map((group) => (
              <div
                key={group.domain}
                className="grid grid-cols-[1.15fr_0.5fr_0.45fr_0.7fr] items-center border-b border-gray-100 px-3 py-2.5 text-xs last:border-0 dark:border-gray-800"
              >
